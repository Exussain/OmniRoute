...
- OpenAI-compatible API surface for CLI/tools (327 provider catalog entries, 89 executor implementation modules)
...
> **Note:** The matrix below is a representative sample of the 327 provider catalog entries in
